...
define_test(ext_0)
{
    ...
    assert_argument_type(2, bitfield_pos);
    assert_argument_equals(2, bitfield_pos{0});

    assert_argument_type(3, bitfield_size);
    assert_argument_equals(3, bitfield_size{1});
}
...
define_test(ext_1)
{
    ...
    assert_argument_type(2, bitfield_pos);
    assert_argument_equals(2, bitfield_pos{30});

    assert_argument_type(3, bitfield_size);
    assert_argument_equals(3, bitfield_size{32});
}
...
define_test(ins_1)
{
    ...
    assert_argument_type(3, bitfield_size);
    assert_argument_equals(3, bitfield_size{2});
}
