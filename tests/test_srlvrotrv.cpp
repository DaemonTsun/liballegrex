...
define_test(srlv_0)
{
    ...
    assert_argument_type(0, argument_type::MIPS_Register); // rd
    assert_argument_equals(0, mips_register, mips_register::ZERO);

    assert_argument_type(1, argument_type::MIPS_Register); // rt
    assert_argument_equals(1, mips_register, mips_register::ZERO);

    assert_argument_type(2, argument_type::MIPS_Register); // rs
