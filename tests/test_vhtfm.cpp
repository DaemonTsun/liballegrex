...
define_test(vhtfm2_1)
{
    ...
    assert_argument_equals(2, vfpu_register{7, vfpu_size::Pair});
}
...
define_test(vhtfm3_0)
{
    ...
    assert_argument_type(1, vfpu_matrix);
    assert_argument_equals(1, vfpu_matrix{0, vfpu_size::Triple});
...
define_test(vhtfm3_1)
{
    ...
    assert_argument_equals(0, vfpu_register{1, vfpu_size::Triple});
    assert_argument_equals(1, vfpu_matrix{3, vfpu_size::Triple});
    assert_argument_equals(2, vfpu_register{7, vfpu_size::Triple});
}
...
define_test(vhtfm4_0)
{
    ...
    assert_argument_type(1, vfpu_matrix);
    assert_argument_equals(1, vfpu_matrix{0, vfpu_size::Quad});
...
define_test(vhtfm4_1)
{
    ...
    assert_argument_equals(0, vfpu_register{1, vfpu_size::Quad});
    assert_argument_equals(1, vfpu_matrix{3, vfpu_size::Quad});
    assert_argument_equals(2, vfpu_register{7, vfpu_size::Quad});
}
