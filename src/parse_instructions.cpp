...
constexpr std::array instructions_Special = {
    ...
    I(MOVZ,    0x0000000a, arg_parse_RsRtRd),
    I(MOVN,    0x0000000b, arg_parse_RsRtRd),
    ...
    I(CLZ,     0x00000016, arg_parse_RsRd),
    I(CLO,     0x00000017, arg_parse_RsRd),
    ...
    I(ADD,     0x00000020, arg_parse_RsRtRd),
    I(ADDU,    0x00000021, arg_parse_AdduOr),
    I(SUB,     0x00000022, arg_parse_RsRtRd),
    I(SUBU,    0x00000023, arg_parse_RsRtRd),
    I(AND,     0x00000024, arg_parse_RsRtRd),
    I(OR,      0x00000025, arg_parse_AdduOr),
    I(XOR,     0x00000026, arg_parse_RsRtRd),
    I(NOR,     0x00000027, arg_parse_RsRtRd),
    I(SLT,     0x0000002a, arg_parse_RsRtRd),
    I(SLTU,    0x0000002b, arg_parse_RsRtRd),
    I(MAX,     0x0000002c, arg_parse_RsRtRd),
    I(MIN,     0x0000002d, arg_parse_RsRtRd),
...
constexpr std::array instructions_Immediate = {
    ...
    I(SLTIU, 0x2c000000, arg_parse_RsRtImmediateU),
    I(ANDI,  0x30000000, arg_parse_RsRtImmediateS),
